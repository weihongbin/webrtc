...
public class PeerConnectionClient {
  ...
  private void createPeerConnectionInternal(EglBase.Context renderEGLContext) {
    ...
    Log.e(TAG, "Peer connection created."+(peerConnection==null));
  }
  ...
  public void createOffer() {
    executor.execute(new Runnable() {
      @Override
      public void run() {
        Log.e("魏红彬","createOffer"+(peerConnection == null));
        if (peerConnection != null && !isError) {
      ...
      public void run() {
        if (peerConnection != null && !isError) {
          if (queuedRemoteCandidates != null) {
            ...
            Log.e(TAG, "addRemoteIceCandidate"+ peerConnection.addIceCandidate(candidate));
  ...
  private void drainCandidates() {
    if (queuedRemoteCandidates != null) {
      Log.e(TAG, "Add " + queuedRemoteCandidates.size() + " remote candidates");
