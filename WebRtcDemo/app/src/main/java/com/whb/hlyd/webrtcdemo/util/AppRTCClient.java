...
package com.whb.hlyd.webrtcdemo.util;
...
public interface AppRTCClient {
  ...
  interface SignalingEvents {
     ...
     */
    void onConnectedToRoom(final SignalingParameters params, final SinglingReadyEvents events1);
     ...
     * @param sdp
     */
    void onCreateAnwser(String sdp);
